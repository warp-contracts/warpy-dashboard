...
import { queryDre, stateFromDre, userLatestRewards, getAllTimeRanking, getSeasonRanking, getRanking } from './utils';
...
const [rsg, { mutate: mutateRsg }] = createResource(walletAddress, queryDre);
...
const App: Component = () => {
  return (
    <>
      <ActionModal handleCloseModal={handleCloseModal} showModal={showModal()} />
      <Header
